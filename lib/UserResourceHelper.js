...
export default class UserResouceHelper {
    constructor(fkPlatform) {
        this.getMerchantCredential = (merchant) => {
        ...
        this.getTokenForCreds = (scope) => __awaiter(this, void 0, void 0, function* () {
            let scopeReq = JSON.parse(scope);
            let response;
            try {
                let fkPlatformResponse = yield this.fkPlatform.getModuleHelper().getPermissionsModule().getToken(scopeReq);
        ...
        this.getIdentityToken = (grantToken) => __awaiter(this, void 0, void 0, function* () {
            let response = yield fetch("https://platform.flipkart.net/1/authorization/auth?grantToken=" + grantToken + "&clientId=" + this.clientId + "&clientSecret=" + this.secret, {
                headers: {
        ...
        this.getUserInfo = (postResourceBody, accessToken) => __awaiter(this, void 0, void 0, function* () {
            // ["user.mobile", "user.email", "user.accountId"];
            let response = yield fetch("https://platform.flipkart.net/1/resource/bulk?accessToken=" + accessToken, {
        ...
        this.startPayment = (identityToken) => __awaiter(this, void 0, void 0, function* () {
            debugger;
            var amountPaise = 500;
            ...
            let response = yield fetch("https://platform.flipkart.net/1/payment/token", {
...
;
//# sourceMappingURL=UserResourceHelper.js.map