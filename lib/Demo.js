...
export default class Demo extends Component {
    constructor(props) {
        super(props);
        this.onPermissionChecked = (permission) => {
            const grantedPerms = [];
        ...
        this.getPermission = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.pickContact = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.fetchContacts = () => __awaiter(this, void 0, void 0, function* () {
            let contactModule = this.fkPlatform.getModuleHelper().getContactsModule();
            let response;
            try {
        ...
        this.storeInformation = () => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.getInformation = () => __awaiter(this, void 0, void 0, function* () {
            try {
                let response = yield AsyncStorage.getItem(this.state.asyncStorageKeyToFetch);
                this.setState({
        ...
        this.callNumber = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.sendTravelSearchBreadcrumbEvent = () => {
    ...
    render() {
        return (<ScrollView>
                <View style={styles.container}>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ text })} value={this.state.text}/>
                    <Text style={{ fontSize: 14 }}> Token output:</Text>
                    <TextInput style={styles.permissionInput} onChangeText={(text) => this.setState({ tokenOutput: text })} value={this.state.tokenOutput}/>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ identityToken: text })} value={this.state.identityToken}/>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ jusPayToken: text })} value={this.state.jusPayToken}/>
                    ...
                    <Text style={{ fontSize: 14, marginBottom: 12 }}>Token:</Text>
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ phonePeToken: text })} value={this.state.phonePeToken}/>
                    ...
                    <TextInput style={styles.permissionInput} onChangeText={(text) => this.setState({ fetchContactsForValue: text })} value={this.state.fetchContactsForValue}/>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ asyncStorageStringToSave: text })} value={this.state.asyncStorageStringToSave}/>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ asyncStorageKeyToFetch: text })} value={this.state.asyncStorageKeyToFetch}/>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ navigateToFlipkartUrl: text })} value={this.state.navigateToFlipkartUrl}/>
                    ...
                    <TextInput style={[styles.permissionInput, { marginTop: 0 }]} onChangeText={(text) => this.setState({ notifyPageLocationChangeUrl: text })} value={this.state.notifyPageLocationChangeUrl}/>
            ...
            return <CheckBox title={permission} key={permission} checked={this.state.permissions.indexOf(permission) > -1} onPress={() => this.onPermissionChecked(permission)}/>;
        })}
